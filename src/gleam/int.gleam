...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.parse")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.base_parse")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.to_string")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.to_base_string")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.to_float")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.bitwise_and")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.bitwise_not")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.bitwise_or")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.bitwise_exclusive_or")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.bitwise_shift_left")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Int.bitwise_shift_right")
