...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.IO.print")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.IO.print_error")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.IO.println")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.IO.println_error")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.IO.debug")
