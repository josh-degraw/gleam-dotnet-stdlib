...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.from_string")
...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.byte_size")
...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.slice")
pub fn slice(
...
@target(fsharp)
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.is_utf8")
fn do_is_utf8(bits: BitArray) -> Bool
...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.to_string")
...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.concat")
...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.base64_encode")
...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.base64_decode")
...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.base16_encode")
...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.base16_decode")
...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.inspect")
...
@external(fsharp, "../gleam_stdlib.fsx", "BitArray.to_int_and_size")
