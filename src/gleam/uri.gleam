...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Uri.parse_query")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Uri.percent_encode")
...
@external(fsharp, "../gleam_stdlib.fs", "Gleam.Uri.percent_decode")
